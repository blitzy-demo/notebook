...
class CollaborationWebSocketHandler(WebSocketHandler):
    ...
    def _has_permission(self, permission: str) -> bool:
        ...
        if permission == 'read':
            ...
            return 'admin' in self.user_info.get('groups', [])
    ...
    def handle_sync(self, message_data: Dict[str, Any]) -> None:
        """
        Handle sync message - to be implemented by subclasses.
        
        Args:
            message_data: Sync message data
        """
        raise NotImplementedError("Subclasses must implement handle_sync")
    
    def handle_awareness(self, message_data: Dict[str, Any]) -> None:
        """
        Handle awareness message - to be implemented by subclasses.
        
        Args:
            message_data: Awareness message data
        """
        raise NotImplementedError("Subclasses must implement handle_awareness")
    
    def handle_comments(self, message_data: Dict[str, Any]) -> None:
        """
        Handle comments message - to be implemented by subclasses.
        
        Args:
            message_data: Comments message data
        """
        raise NotImplementedError("Subclasses must implement handle_comments")


class CollaborationSyncHandler(CollaborationWebSocketHandler):
    """
    ...
    def authenticate_websocket(self) -> bool:
        """
        Authenticate WebSocket connection for sync operations.
...
class CollaborationAwarenessHandler(CollaborationWebSocketHandler):
    """
    ...
    def open(self, document_path: str):
        ...
        try:
            ...
            self.awareness_state = {
                'user_id': self.user_id,
                'username': self.user_info.get('username', self.user_id),
                'status': 'online',
...
class CollaborationCommentsHandler(CollaborationWebSocketHandler):
    """
